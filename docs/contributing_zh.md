...
1. FORK 点击项目右上角的fork按钮，把Stevent-fei/test-release fork到自己的仓库中如 fanux/sealer
2. CLONE 把fork后的项目clone到自己本地，如`git clone https://github.com/<Your-GitHub-ID>/sealer`
3. Set Remote upstream, 方便把Stevent-fei/test-release的代码更新到自己的仓库中
...
可以到issue中去寻找已经贴了[kind/feature](https://../../issues?q=is%3Aissue+is%3Aopen+label%3Akind%2Ffeature)标签的任务，注意有的需求
